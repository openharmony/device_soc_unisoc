...
enum setting_cmd_type {
    ...
    SETTING_GET_YUV3_SIZE,
    SETTING_GET_YUV3_FORMAT,
    SETTING_GET_CHANNEL4_SIZE,
    SETTING_GET_CHANNEL4_FORMAT,
    SETTING_GET_CHANNEL5_SIZE,
    SETTING_GET_CHANNEL5_FORMAT,
    ...
    SETTING_GET_P2P_ENABLE,//picture in picture enable
    SETTING_GET_LAST_PREFLASH_TIME,
    SETTING_SET_FLASH_CALIBRATION,
    SETTING_GET_FRAMES_CUR_SNAPSHOT,
    SETTING_GET_SPRD_ULTRA_DISTORTION_CORRECT_ENABLE,
    SETTING_GET_FPS_RANGE,
    SETTING_GET_FT_ENABLE,
    SETTING_GET_AI_SFNR_ENABLE,
    SETTING_GET_MOTION_PHOTO_ENABLE,
    SETTING_GET_FLASH_AF_STATUS,
    SETTING_GET_CALLBACK_STREAM_INFO,
    SETTING_RESET_CALLBACK_STREAM_INFO,
    SETTING_CTRL_AE_CAP_PARAM,
    SETTING_TYPE_MAX = 300
};
...
struct setting_cmd_parameter {
    ...
    union {
        ...
        cmr_u32 flash_no_af;
        struct cmr_ae_expo_cap_param ae_cap_param;
        struct setting_hal_common hal_callback_stream_info;
    };
};
