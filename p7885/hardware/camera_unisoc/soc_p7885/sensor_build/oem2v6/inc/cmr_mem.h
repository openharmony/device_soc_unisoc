...
int camera_set_largest_pict_size(cmr_u32 camera_id, cmr_u16 width,
                                 cmr_u16 height);
cmr_u16 * camera_get_largest_pic_width(void);
cmr_u16 * camera_get_largest_pic_height(void);
...
int camera_arrange_capture_buf(
    ...
    struct cmr_cap_mem *capture_mem, cmr_u32 raw_fmt, uint32_t need_rot, uint32_t need_scale,
