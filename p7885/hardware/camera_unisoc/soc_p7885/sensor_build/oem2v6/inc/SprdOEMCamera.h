...
cmr_int camera_get_camera_type(cmr_handle camera_handle,
                                     cmr_u32 cam_type);
...
cmr_int camera_get_sensor_otp_info(cmr_handle camera_handle, cmr_u8 dual_flag,
                                    struct sensor_otp_cust_info *otp_info);
cmr_int camera_get_sensor_vcm_step(cmr_handle camera_handle, cmr_u32 camera_id,
                                    cmr_u32 *vcm_step);
...
void camera_stop_hdr_capture(cmr_handle handle);
void camera_stop_night_capture(cmr_handle handle);
