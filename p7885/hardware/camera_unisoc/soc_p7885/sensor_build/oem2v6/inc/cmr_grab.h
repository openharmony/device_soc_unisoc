...
typedef cmr_int (*grab_i2c_ops_status)(void *privdata);
...
struct cmr_grab {
    ...
    grab_i2c_ops_status i2c_ops_status_cb;
    cmr_u8 mode_enable;
    cmr_u8 res;
};
...
void cmr_grab_hall_irq_evt_reg(cmr_handle grab_handle,
                                 cmr_evt_cb hall_irq_event_cb);
...
cmr_int cmr_grab_i2c_ops_status_cb(cmr_handle grab_handle,
                                 grab_i2c_ops_status i2c_func);
...
cmr_int cmr_grab_get_flash_info(cmr_handle grab_handle,
                           struct sprd_flash_capacity *cfg);
...
cmr_int cmr_grab_get_dcam_raw_fmt(cmr_handle grab_handle, cmr_u32 *fmt);
cmr_int cmr_grab_postproc_raw(cmr_handle grab_handle, uint32_t cmd, struct sprd_img_parm *param);
cmr_int cmr_grab_virtual_sensor_frame(cmr_handle, void *param);
cmr_int cmr_grab_set_raw(cmr_handle grab_handle, struct sprd_dcam_raw_fmt *fmt);
