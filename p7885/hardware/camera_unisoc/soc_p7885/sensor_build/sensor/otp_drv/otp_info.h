...
#define CHECK_PTR(expr)                                                        \
    if ((expr) == NULL) {                                                      \
        OTP_LOGE("ERROR: NULL pointer detected " #expr);                          \
        return FALSE;                                                          \
    }
#endif
...
typedef struct {
    ...
    /* added in otp 2.0 */
    otp_section_info_t sl_cali_dat;         /*structured light*/
    otp_section_info_t microspur_cali_dat;  /*microspur*/
    otp_section_info_t uww_cali_dat;        /*uw+w*/
    otp_section_info_t customize_cali_dat;  /*customize*/
