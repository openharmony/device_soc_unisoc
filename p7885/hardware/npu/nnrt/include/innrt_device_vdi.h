...
#define NNRT_DEVICE_VDI_LIBRARY "libnnrt_vdi_impl.z.so"
...
public:
    ...
    virtual int32_t IsFloat16PrecisionSupported(bool& isSupported) const = 0;
    virtual int32_t IsPerformanceModeSupported(bool& isSupported) const = 0;
    virtual int32_t IsPrioritySupported(bool& isSupported) const = 0;
    virtual int32_t IsDynamicInputSupported(bool& isSupported) const = 0;
    ...
    virtual int32_t IsModelCacheSupported(bool& isSupported) const = 0;
