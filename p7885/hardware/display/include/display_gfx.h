...
/**
 * @brief Extended definition hardware acceleration options
 *
 */
struct SprdGfxOpt {
    GfxOpt *opt;
    unsigned int zOrder; /* *< layer zOrder */
    unsigned int index;  /* *< layers index */
    unsigned int maxCnt; /* *< layers count */
};
} // DISPLAY
}  // HDI
}  // OHOS
